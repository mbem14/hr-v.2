...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.employeeAppraisal.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employee-appraisals.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_1') ? 'is-invalid' : '' }}" type="number" name="pilih_1" id="pilih_1" value="{{ old('pilih_1', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_2') ? 'is-invalid' : '' }}" type="number" name="pilih_2" id="pilih_2" value="{{ old('pilih_2', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_3') ? 'is-invalid' : '' }}" type="number" name="pilih_3" id="pilih_3" value="{{ old('pilih_3', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_4') ? 'is-invalid' : '' }}" type="number" name="pilih_4" id="pilih_4" value="{{ old('pilih_4', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_5') ? 'is-invalid' : '' }}" type="number" name="pilih_5" id="pilih_5" value="{{ old('pilih_5', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_6') ? 'is-invalid' : '' }}" type="number" name="pilih_6" id="pilih_6" value="{{ old('pilih_6', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_7') ? 'is-invalid' : '' }}" type="number" name="pilih_7" id="pilih_7" value="{{ old('pilih_7', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_8') ? 'is-invalid' : '' }}" type="number" name="pilih_8" id="pilih_8" value="{{ old('pilih_8', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_9') ? 'is-invalid' : '' }}" type="number" name="pilih_9" id="pilih_9" value="{{ old('pilih_9', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_10') ? 'is-invalid' : '' }}" type="number" name="pilih_10" id="pilih_10" value="{{ old('pilih_10', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_11') ? 'is-invalid' : '' }}" type="number" name="pilih_11" id="pilih_11" value="{{ old('pilih_11', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_12') ? 'is-invalid' : '' }}" type="number" name="pilih_12" id="pilih_12" value="{{ old('pilih_12', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_13') ? 'is-invalid' : '' }}" type="number" name="pilih_13" id="pilih_13" value="{{ old('pilih_13', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_14') ? 'is-invalid' : '' }}" type="number" name="pilih_14" id="pilih_14" value="{{ old('pilih_14', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_15') ? 'is-invalid' : '' }}" type="number" name="pilih_15" id="pilih_15" value="{{ old('pilih_15', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_16') ? 'is-invalid' : '' }}" type="number" name="pilih_16" id="pilih_16" value="{{ old('pilih_16', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_17') ? 'is-invalid' : '' }}" type="number" name="pilih_17" id="pilih_17" value="{{ old('pilih_17', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_18') ? 'is-invalid' : '' }}" type="number" name="pilih_18" id="pilih_18" value="{{ old('pilih_18', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_19') ? 'is-invalid' : '' }}" type="number" name="pilih_19" id="pilih_19" value="{{ old('pilih_19', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilih_20') ? 'is-invalid' : '' }}" type="number" name="pilih_20" id="pilih_20" value="{{ old('pilih_20', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('target_1') ? 'is-invalid' : '' }}" type="number" name="target_1" id="target_1" value="{{ old('target_1', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('target_2') ? 'is-invalid' : '' }}" type="number" name="target_2" id="target_2" value="{{ old('target_2', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('target_3') ? 'is-invalid' : '' }}" type="number" name="target_3" id="target_3" value="{{ old('target_3', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('target_4') ? 'is-invalid' : '' }}" type="number" name="target_4" id="target_4" value="{{ old('target_4', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('target_5') ? 'is-invalid' : '' }}" type="number" name="target_5" id="target_5" value="{{ old('target_5', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reali_1') ? 'is-invalid' : '' }}" type="number" name="reali_1" id="reali_1" value="{{ old('reali_1', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reali_2') ? 'is-invalid' : '' }}" type="number" name="reali_2" id="reali_2" value="{{ old('reali_2', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reali_3') ? 'is-invalid' : '' }}" type="number" name="reali_3" id="reali_3" value="{{ old('reali_3', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reali_4') ? 'is-invalid' : '' }}" type="number" name="reali_4" id="reali_4" value="{{ old('reali_4', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reali_5') ? 'is-invalid' : '' }}" type="number" name="reali_5" id="reali_5" value="{{ old('reali_5', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_1') ? 'is-invalid' : '' }}" type="number" name="nilai_1" id="nilai_1" value="{{ old('nilai_1', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_2') ? 'is-invalid' : '' }}" type="number" name="nilai_2" id="nilai_2" value="{{ old('nilai_2', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_3') ? 'is-invalid' : '' }}" type="number" name="nilai_3" id="nilai_3" value="{{ old('nilai_3', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_4') ? 'is-invalid' : '' }}" type="number" name="nilai_4" id="nilai_4" value="{{ old('nilai_4', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_5') ? 'is-invalid' : '' }}" type="number" name="nilai_5" id="nilai_5" value="{{ old('nilai_5', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\EmployeeAppraisal::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', 'Send') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
