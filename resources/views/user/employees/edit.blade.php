    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employee_number') ? 'is-invalid' : '' }}" type="text" name="employee_number" id="employee_number" value="{{ old('employee_number', $employee->employee_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('middle_name') ? 'is-invalid' : '' }}" type="text" name="middle_name" id="middle_name" value="{{ old('middle_name', $employee->middle_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('front_title') ? 'is-invalid' : '' }}" type="text" name="front_title" id="front_title" value="{{ old('front_title', $employee->front_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('back_title') ? 'is-invalid' : '' }}" type="text" name="back_title" id="back_title" value="{{ old('back_title', $employee->back_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('birth_place') ? 'is-invalid' : '' }}" type="text" name="birth_place" id="birth_place" value="{{ old('birth_place', $employee->birth_place) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('birthday') ? 'is-invalid' : '' }}" type="text" name="birthday" id="birthday" value="{{ old('birthday', $employee->birthday) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('religion') ? 'is-invalid' : '' }}" name="religion" id="religion" required>
                    ...
                    @foreach(App\Models\Employee::RELIGION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('religion', $employee->religion) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nationality') ? 'is-invalid' : '' }}" name="nationality_id" id="nationality_id">
                    @foreach($nationalities as $id => $nationality)
                        <option value="{{ $id }}" {{ (old('nationality_id') ? old('nationality_id') : $employee->nationality->id ?? '') == $id ? 'selected' : '' }}>{{ $nationality }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blood_type') ? 'is-invalid' : '' }}" type="text" name="blood_type" id="blood_type" value="{{ old('blood_type', $employee->blood_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_card') ? 'is-invalid' : '' }}" type="text" name="id_card" id="id_card" value="{{ old('id_card', $employee->id_card) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_1') ? 'is-invalid' : '' }}" type="text" name="address_1" id="address_1" value="{{ old('address_1', $employee->address_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_2') ? 'is-invalid' : '' }}" type="text" name="address_2" id="address_2" value="{{ old('address_2', $employee->address_2) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('country') ? 'is-invalid' : '' }}" name="country_id" id="country_id">
                    @foreach($countries as $id => $country)
                        <option value="{{ $id }}" {{ (old('country_id') ? old('country_id') : $employee->country->id ?? '') == $id ? 'selected' : '' }}>{{ $country }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('province') ? 'is-invalid' : '' }}" name="province_id" id="province_id" required>
                    @foreach($provinces as $id => $province)
                        <option value="{{ $id }}" {{ (old('province_id') ? old('province_id') : $employee->province->id ?? '') == $id ? 'selected' : '' }}>{{ $province }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postal_code') ? 'is-invalid' : '' }}" type="text" name="postal_code" id="postal_code" value="{{ old('postal_code', $employee->postal_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('home_phone') ? 'is-invalid' : '' }}" type="text" name="home_phone" id="home_phone" value="{{ old('home_phone', $employee->home_phone) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('job_title') ? 'is-invalid' : '' }}" name="job_title_id" id="job_title_id" required>
                    @foreach($job_titles as $id => $job_title)
                        <option value="{{ $id }}" {{ (old('job_title_id') ? old('job_title_id') : $employee->job_title->id ?? '') == $id ? 'selected' : '' }}>{{ $job_title }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('joined_date') ? 'is-invalid' : '' }}" type="text" name="joined_date" id="joined_date" value="{{ old('joined_date', $employee->joined_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('confirmation_date') ? 'is-invalid' : '' }}" type="text" name="confirmation_date" id="confirmation_date" value="{{ old('confirmation_date', $employee->confirmation_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_decree') ? 'is-invalid' : '' }}" type="text" name="number_decree" id="number_decree" value="{{ old('number_decree', $employee->number_decree) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('terminate_date') ? 'is-invalid' : '' }}" type="text" name="terminate_date" id="terminate_date" value="{{ old('terminate_date', $employee->terminate_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('work_phone') ? 'is-invalid' : '' }}" type="text" name="work_phone" id="work_phone" value="{{ old('work_phone', $employee->work_phone) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('work_email') ? 'is-invalid' : '' }}" type="email" name="work_email" id="work_email" value="{{ old('work_email', $employee->work_email) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('private_email') ? 'is-invalid' : '' }}" type="email" name="private_email" id="private_email" value="{{ old('private_email', $employee->private_email) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('department') ? 'is-invalid' : '' }}" name="department_id" id="department_id">
                    @foreach($departments as $id => $department)
                        <option value="{{ $id }}" {{ (old('department_id') ? old('department_id') : $employee->department->id ?? '') == $id ? 'selected' : '' }}>{{ $department }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('supervisor') ? 'is-invalid' : '' }}" name="supervisor_id" id="supervisor_id" required>
                    @foreach($supervisors as $id => $supervisor)
                        <option value="{{ $id }}" {{ (old('supervisor_id') ? old('supervisor_id') : $employee->supervisor->id ?? '') == $id ? 'selected' : '' }}>{{ $supervisor }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('indirect_supervisors') ? 'is-invalid' : '' }}" name="indirect_supervisors_id" id="indirect_supervisors_id">
                    @foreach($indirect_supervisors as $id => $indirect_supervisors)
                        <option value="{{ $id }}" {{ (old('indirect_supervisors_id') ? old('indirect_supervisors_id') : $employee->indirect_supervisors->id ?? '') == $id ? 'selected' : '' }}>{{ $indirect_supervisors }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('employment_status') ? 'is-invalid' : '' }}" name="employment_status_id" id="employment_status_id" required>
                    @foreach($employment_statuses as $id => $employment_status)
                        <option value="{{ $id }}" {{ (old('employment_status_id') ? old('employment_status_id') : $employee->employment_status->id ?? '') == $id ? 'selected' : '' }}>{{ $employment_status }}</option>
                    @endforeach
                </select>
