    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.leave-types.update", [$leaveType->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $leaveType->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('default_per_year') ? 'is-invalid' : '' }}" type="number" name="default_per_year" id="default_per_year" value="{{ old('default_per_year', $leaveType->default_per_year) }}" step="0.001" required>
