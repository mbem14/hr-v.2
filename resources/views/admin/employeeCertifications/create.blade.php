...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.employeeCertification.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.employee-certifications.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="certification">{{ trans('cruds.employeeCertification.fields.certification') }}</label>
                <input class="form-control {{ $errors->has('certification') ? 'is-invalid' : '' }}" type="text" name="certification" id="certification" value="{{ old('certification', '') }}" required>
