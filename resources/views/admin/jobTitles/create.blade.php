    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.job-titles.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('main_purpose') ? 'is-invalid' : '' }}" name="main_purpose" id="main_purpose">{{ old('main_purpose') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('challange') ? 'is-invalid' : '' }}" name="challange" id="challange">{{ old('challange') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('authority') ? 'is-invalid' : '' }}" name="authority" id="authority">{{ old('authority') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('internal_relation') ? 'is-invalid' : '' }}" name="internal_relation" id="internal_relation">{{ old('internal_relation') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('external_relation') ? 'is-invalid' : '' }}" name="external_relation" id="external_relation">{{ old('external_relation') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('financial_dimension') ? 'is-invalid' : '' }}" name="financial_dimension" id="financial_dimension">{{ old('financial_dimension') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('hr_dimension') ? 'is-invalid' : '' }}" name="hr_dimension" id="hr_dimension">{{ old('hr_dimension') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('qualification') ? 'is-invalid' : '' }}" name="qualification" id="qualification">{{ old('qualification') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('training_need') ? 'is-invalid' : '' }}" name="training_need" id="training_need">{{ old('training_need') }}</textarea>
