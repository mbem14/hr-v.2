...
class EmployeesController extends Controller
{
    ...
    public function create()
    {
        ...
        $supervisors = Employee::all()->pluck('first_name', 'id')->prepend(trans('global.pleaseSelect'), '');

        $indirect_supervisors = Employee::all()->pluck('first_name', 'id')->prepend(trans('global.pleaseSelect'), '');
