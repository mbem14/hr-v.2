...
class EmployeeAppraisalsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.employeeAppraisals.create', compact('employees', 'periods', 'evaluators'));
    }
    ...
    public function store(StoreEmployeeAppraisalRequest $request)
    {
        ...
        return redirect()->route('admin.employee-appraisals.index');
    }
    ...
    public function edit(EmployeeAppraisal $employeeAppraisal)
    {
        ...
        return view('admin.employeeAppraisals.edit', compact('employees', 'periods', 'evaluators', 'employeeAppraisal'));
    }
    ...
    public function show(EmployeeAppraisal $employeeAppraisal)
    {
        ...
        return view('admin.employeeAppraisals.show', compact('employeeAppraisal'));
    }
